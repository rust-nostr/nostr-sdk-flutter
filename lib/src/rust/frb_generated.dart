...
class NostrSdk
  ...
  @override
  int get rustContentHash => -1112789059;
...
abstract class NostrSdkApi extends BaseApi {
  ...
  List<Event> crateApiDatabaseEventsEventsAsVec({required Events that});
...
class NostrSdkApiImpl extends NostrSdkApiImplPlatform implements NostrSdkApi {
  ...
  List<Event> crateApiDatabaseEventsEventsAsVec({required Events that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiDatabaseEventsEventsAsVecConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDatabaseEventsEventsAsVecConstMeta =>
      const TaskConstMeta(
        debugName: "Events_as_vec",
        argNames: ["that"],
      );
...
class EventsImpl extends RustOpaque implements Events {
  ...
  List<Event> asVec() =>
      NostrSdk.instance.api.crateApiDatabaseEventsEventsAsVec(
        that: this,
      );
